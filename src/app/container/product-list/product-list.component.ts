...
export class ProductListComponent {
  ...
  totalProductInStock = this.products.filter(prod => prod.is_in_inventory == true).length;
  totalProductOutOfStock = this.products.filter(prod => prod.is_in_inventory === false).length;
